...
*GroupApi* | [**get_groups**](docs/GroupApi.md#get_groups) | **GET** /group/ | Read groups
...
*RoleApi* | [**get_role**](docs/RoleApi.md#get_role) | **GET** /role/{role_id} | Read a role
*RoleApi* | [**get_roles**](docs/RoleApi.md#get_roles) | **GET** /role/ | Read roles
...
*ServiceAccountApi* | [**create_service_account**](docs/ServiceAccountApi.md#create_service_account) | **POST** /user/{user_id}/service_account/ | Create a service account
*ServiceAccountApi* | [**delete_service_account**](docs/ServiceAccountApi.md#delete_service_account) | **DELETE** /user/{user_id}/service_account/{service_account_id} | Delete a service_account
*ServiceAccountApi* | [**get_service_account**](docs/ServiceAccountApi.md#get_service_account) | **GET** /user/{user_id}/service_account/{service_account_id} | Read a service account
...
*ServiceAccountApi* | [**rotate_key**](docs/ServiceAccountApi.md#rotate_key) | **PATCH** /user/{user_id}/service_account/{service_account_id}/rotate_key | Rotate a service account key
*ServiceAccountApi* | [**update_service_account**](docs/ServiceAccountApi.md#update_service_account) | **PATCH** /user/{user_id}/service_account/{service_account_id} | Update a service account
...
*UserApi* | [**get_users**](docs/UserApi.md#get_users) | **GET** /user/ | Get Many
