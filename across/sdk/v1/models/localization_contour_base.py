...
class LocalizationContourBase(BaseModel):
    """
    ...
    """ # noqa: E501
    contour: List[Point]
    __properties: ClassVar[List[str]] = ["contour"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in contour (list)
        _items = []
        if self.contour:
            for _item_contour in self.contour:
                if _item_contour:
                    _items.append(_item_contour.to_dict())
            _dict['contour'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contour": [Point.from_dict(_item) for _item in obj["contour"]] if obj.get("contour") is not None else None
        })
        return _obj
