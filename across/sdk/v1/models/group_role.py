...
class GroupRole(BaseModel):
    ...
    id: StrictStr
    group: AcrossServerRoutesV1GroupRoleSchemasGroup
    users: List[AcrossServerRoutesV1GroupRoleSchemasUser]
    service_accounts: Optional[List[ServiceAccount]]
    __properties: ClassVar[List[str]] = ["name", "permissions", "id", "group", "users", "service_accounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "group": AcrossServerRoutesV1GroupRoleSchemasGroup.from_dict(obj["group"]) if obj.get("group") is not None else None,
            ...
            "service_accounts": [ServiceAccount.from_dict(_item) for _item in obj["service_accounts"]] if obj.get("service_accounts") is not None else None
        })
        return _obj
