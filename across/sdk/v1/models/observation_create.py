...
class ObservationCreate(BaseModel):
    ...
    footprint: Optional[List[ObservationFootprintCreate]] = None
    __properties: ClassVar[List[str]] = ["instrument_id", "object_name", "pointing_position", "date_range", "external_observation_id", "type", "status", "pointing_angle", "exposure_time", "reason", "description", "proposal_reference", "object_position", "depth", "bandpass", "t_resolution", "em_res_power", "o_ucd", "pol_states", "pol_xel", "category", "priority", "tracking_type", "created_on", "created_by_id", "footprint"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in footprint (list)
        _items = []
        if self.footprint:
            for _item_footprint in self.footprint:
                if _item_footprint:
                    _items.append(_item_footprint.to_dict())
            _dict['footprint'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "footprint": [ObservationFootprintCreate.from_dict(_item) for _item in obj["footprint"]] if obj.get("footprint") is not None else None
        })
        return _obj
