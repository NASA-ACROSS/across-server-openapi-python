...
SUNALTITUDE_ANY_OF_SCHEMAS = ["List[float]", "float"]

class SunAltitude(BaseModel):
    """
    Altitude of the Sun at the given time
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = SunAltitude.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in SunAltitude with anyOf schemas: List[float], float. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into SunAltitude with anyOf schemas: List[float], float. Details: " + ", ".join(error_messages))
        else:
            return instance
