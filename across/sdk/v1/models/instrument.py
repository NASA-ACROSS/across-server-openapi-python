...
from across.sdk.v1.models.observation_strategy import ObservationStrategy
...
class Instrument(BaseModel):
    ...
    observation_strategy: Optional[ObservationStrategy] = None
    __properties: ClassVar[List[str]] = ["id", "created_on", "name", "short_name", "telescope", "footprints", "filters", "constraints", "visibility_type", "observation_strategy"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if observation_strategy (nullable) is None
        # and model_fields_set contains the field
        if self.observation_strategy is None and "observation_strategy" in self.model_fields_set:
            _dict['observation_strategy'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "observation_strategy": obj.get("observation_strategy")
        })
        return _obj
