...
class Observation(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "footprint": [ObservationFootprint.from_dict(_item) for _item in obj["footprint"]] if obj.get("footprint") is not None else None
        })
        return _obj
