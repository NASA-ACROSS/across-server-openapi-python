...
class Observation(BaseModel):
    ...
    pointing_position: Optional[AcrossServerCoreSchemasCoordinateCoordinate] = None
    ...
    object_position: Optional[AcrossServerCoreSchemasCoordinateCoordinate] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pointing_position": AcrossServerCoreSchemasCoordinateCoordinate.from_dict(obj["pointing_position"]) if obj.get("pointing_position") is not None else None,
            ...
            "object_position": AcrossServerCoreSchemasCoordinateCoordinate.from_dict(obj["object_position"]) if obj.get("object_position") is not None else None,
