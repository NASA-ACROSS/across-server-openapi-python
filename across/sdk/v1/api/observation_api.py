...
class ObservationApi:
    ...
    def contains_point(
        self,
        ra: Union[Annotated[float, Field(strict=True, ge=0.0)], Annotated[int, Field(strict=True, ge=0)]],
        ...
        _param = self._contains_point_serialize(
            ra=ra,
            dec=dec,
            page=page,
    ...
    @validate_call
    def contains_point_with_http_info(
        self,
        ra: Union[Annotated[float, Field(strict=True, ge=0.0)], Annotated[int, Field(strict=True, ge=0)]],
        dec: Union[Annotated[float, Field(le=90.0, strict=True, ge=-90.0)], Annotated[int, Field(le=90, strict=True, ge=-90)]],
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Page number")] = None,
    ...
    @validate_call
    def contains_point_without_preload_content(
        self,
        ra: Union[Annotated[float, Field(strict=True, ge=0.0)], Annotated[int, Field(strict=True, ge=0)]],
        dec: Union[Annotated[float, Field(le=90.0, strict=True, ge=-90.0)], Annotated[int, Field(le=90, strict=True, ge=-90)]],
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Page number")] = None,
    ...
    def _contains_point_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/observation/search/contains-point/',
    ...
    def get_observations(
        ...
        depth_unit: Optional[DepthUnit] = None,
        include_footprints: Optional[StrictBool] = None,
        cone_search_ra: Optional[Union[Annotated[float, Field(strict=True, ge=0.0)], Annotated[int, Field(strict=True, ge=0)]]] = None,
        cone_search_dec: Optional[Union[Annotated[float, Field(le=90.0, strict=True, ge=-90.0)], Annotated[int, Field(le=90, strict=True, ge=-90)]]] = None,
