...
class ScheduleApi:
    ...
    def get_schedule(
        ...
        include_observations_footprints: Optional[StrictBool] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param include_observations_footprints:
        :type include_observations_footprints: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _get_schedule_serialize(
        ...
        include_observations_footprints,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if include_observations_footprints is not None:
            
            _query_params.append(('include_observations_footprints', include_observations_footprints))
