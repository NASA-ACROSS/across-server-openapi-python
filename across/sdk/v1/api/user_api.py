...
class UserApi:
    ...
    def get_many_user_get(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[AcrossServerRoutesV1UserSchemasUser]:
        """Read users
        ...
        _param = self._get_many_user_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[AcrossServerRoutesV1UserSchemasUser]",
            '404': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_many_user_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[AcrossServerRoutesV1UserSchemasUser]]:
        """Read users
    ...
    @validate_call
    def get_many_user_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_many_user_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
