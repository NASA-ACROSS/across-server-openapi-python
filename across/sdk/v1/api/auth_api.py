...
class AuthApi:
    ...
    @validate_call
    def local_token_auth_local_token_get(
        self,
        email: StrictStr,
        ...
        For local only, directly return an access token for testing purposes that expires after 1 day
        ...
        _param = self._local_token_auth_local_token_get_serialize(
            email=email,
    ...
    @validate_call
    def local_token_auth_local_token_get_with_http_info(
        self,
        email: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def local_token_auth_local_token_get_without_preload_content(
        self,
        email: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _local_token_auth_local_token_get_serialize(
        self,
        email,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/auth/local-token',
