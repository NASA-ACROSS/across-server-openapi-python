...
class TelescopeApi:
    ...
    def get_telescopes(
        ...
        observatory_id: Optional[StrictStr] = None,
        observatory_name: Optional[StrictStr] = None,
        ...
        :param name:
        :type name: str
        :param observatory_id:
        :type observatory_id: str
        :param observatory_name:
        :type observatory_name: str
        :param instrument_id:
    ...
    def _get_telescopes_serialize(
        ...
        if observatory_id is not None:
            ...
            _query_params.append(('observatory_id', observatory_id))
            
        if observatory_name is not None:
            
            _query_params.append(('observatory_name', observatory_name))
