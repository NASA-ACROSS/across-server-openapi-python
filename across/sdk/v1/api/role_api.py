...
class RoleApi:
    ...
    def get_many_role_get(
        ...
        _param = self._get_many_role_get_serialize(
    ...
    @validate_call
    def get_many_role_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_many_role_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_many_role_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def get_role_role_id_get(
        ...
        _param = self._get_role_role_id_get_serialize(
            role_id=role_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_role_role_id_get_with_http_info(
        self,
        role_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_role_role_id_get_without_preload_content(
        self,
        role_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_role_role_id_get_serialize(
        self,
        role_id,
        _request_auth,
        _content_type,
